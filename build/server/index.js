...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/hooks.server-DySvEohN.js'));
  let reroute;
  let transport;
  return {
    handle,
